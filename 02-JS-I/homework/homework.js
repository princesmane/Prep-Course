...
const nuevaString = "Mane primera vez" ;
...
function resta(x, y) {
  ...
  // en la resta va primero la x y despues la y xq en java emppieza a hacer la operacion de iz a derecha, o sea restaria a la y la x.
}
...
function esVocal(Letra){
  ...
  //Escribe tu código aquí
  var letraMinuscula = Letra.toLowerCase(); // esto es para convertir la letra a minuscula
